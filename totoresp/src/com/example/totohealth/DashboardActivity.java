 ...
 private TextView textv1;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       public void ListDrwaer() {
        List<Map<String, String>> responsesList = new ArrayList<Map<String, String>>();
        ...
        try {
         ...
         //responsesList.add(createResponses("responses"));
         }
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, responsesList,
          android.R.layout.simple_list_item_1,
          new String[] { "jsonResult" }, new int[] { android.R.id.text1 });
        listView.setAdapter(simpleAdapter);
       }

	/*private Map<String, String> createResponses(String string) {
		// TODO Auto-generated method stub
		return null;
	*/

     /* private HashMap<String, String> createResponses(String response) {
        HashMap<String, String> responsesNameNoResp = new HashMap<String, String>();
        responsesNameNoResp.put( response, response);
        return responsesNameNoResp;
       }*/
}
